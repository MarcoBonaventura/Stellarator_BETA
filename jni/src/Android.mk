...
LOCAL_SRC_FILES := C:/ANDROID/AndroidProject/Stellarator_BETA/app/src/main/libs/$(TARGET_ARCH_ABI)/libSDL2.so
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := libmpg123
LOCAL_SRC_FILES := C:/ANDROID/AndroidProject/Stellarator_BETA/app/src/main/libs/$(TARGET_ARCH_ABI)/libmpg123.so
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := libhidapi
LOCAL_SRC_FILES := C:/ANDROID/AndroidProject/Stellarator_BETA/app/src/main/libs/$(TARGET_ARCH_ABI)/libhidapi.so
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := libSDL2_image
LOCAL_SRC_FILES := C:/ANDROID/AndroidProject/Stellarator_BETA/app/src/main/libs/$(TARGET_ARCH_ABI)/libSDL2_image.so
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := libSDL2_mixer
LOCAL_SRC_FILES := C:/ANDROID/AndroidProject/Stellarator_BETA/app/src/main/libs/$(TARGET_ARCH_ABI)/libSDL2_mixer.so
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := libSDL2_ttf
LOCAL_SRC_FILES := C:/ANDROID/AndroidProject/Stellarator_BETA/app/src/main/libs/$(TARGET_ARCH_ABI)/libSDL2_ttf.so
include $(PREBUILT_SHARED_LIBRARY)
